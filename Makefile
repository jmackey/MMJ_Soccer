...
UNREALROOTPATH = /home/jmackey/repos/UnrealEngine
GAMEPROJECTFILE =/home/jmackey/Documents/Unreal Projects/StarterSoccer/StarterSoccer.uproject

TARGETS = \
	StarterSoccer-Linux-Debug  \
	StarterSoccer-Linux-DebugGame  \
	StarterSoccer-Linux-Test  \
	StarterSoccer-Linux-Shipping  \
	StarterSoccer \
	StarterSoccerEditor-Linux-Debug  \
	StarterSoccerEditor-Linux-DebugGame  \
	StarterSoccerEditor-Linux-Test  \
	StarterSoccerEditor-Linux-Shipping  \
	StarterSoccerEditor \
...
StandardSet: RequiredTools UnrealFrontend StarterSoccerEditor UnrealInsights

DebugSet: RequiredTools UnrealFrontend-Linux-Debug StarterSoccerEditor-Linux-Debug


StarterSoccer-Linux-Debug:
	 $(PROJECTBUILD) StarterSoccer Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

StarterSoccer-Linux-DebugGame:
	 $(PROJECTBUILD) StarterSoccer Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

StarterSoccer-Linux-Test:
	 $(PROJECTBUILD) StarterSoccer Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

StarterSoccer-Linux-Shipping:
	 $(PROJECTBUILD) StarterSoccer Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

StarterSoccer:
	 $(PROJECTBUILD) StarterSoccer Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)

StarterSoccerEditor-Linux-Debug:
	 $(PROJECTBUILD) StarterSoccerEditor Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

StarterSoccerEditor-Linux-DebugGame:
	 $(PROJECTBUILD) StarterSoccerEditor Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

StarterSoccerEditor-Linux-Test:
	 $(PROJECTBUILD) StarterSoccerEditor Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

StarterSoccerEditor-Linux-Shipping:
	 $(PROJECTBUILD) StarterSoccerEditor Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

StarterSoccerEditor:
	 $(PROJECTBUILD) StarterSoccerEditor Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)
